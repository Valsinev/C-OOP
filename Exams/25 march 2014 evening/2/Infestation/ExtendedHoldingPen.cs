...
namespace Infestation
{
    public class ExtendedHoldingPen : HoldingPen
    {
        ...
        protected override void ExecuteAddSupplementCommand(string[] commandWords)
        {
            ...
            {
                case "Weapon":
                    suplement = new Weapon(commandWords[2]);
                    break;
                case "AggressionCatalyst":
                    suplement = new AggressionCatalyst(commandWords[2]);
                    break;
                case "HealthCatalyst":
                    suplement = new HealthCatalyst(commandWords[2]);
                    break;
                case "PowerCatalyst":
                    suplement = new PowerCatalyst(commandWords[2]);
                    break;
                default:
